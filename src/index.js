...
let imageCreditsList = [
    'Bacon Cheeseburger Photo by <a href="https://unsplash.com/es/@wondermario__?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Mario</a> on <a href="https://unsplash.com/s/photos/comfort-food?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>',
...
pageCredits.textContent =
    'Project created by Derek for The Odin Project - Restaurant Page Project';
...
const splashBtnMenu = document.querySelector('#splash-btn-menu');
splashBtnMenu.addEventListener('click', () => {
    mainContainer.innerHTML = '';
    mainContainer.append(menuContainer);
});
